    ...
    <main>
        <div class="contents">
            ...
            <form id="form" action="./post.php" method="post">
                ...
                <h4 class="category_title_sub" style="margin-top: 10vh;">タグ</h4>
                <p class="tag" id="tag_list"></p>
                <br>
                <!-- タグ追加 -->
                <div style="width: 80%; font-size: 25px; margin: auto;">
                    <p id="tagPrepare"></p>
                    <input type="text" id="tags" name="tags" placeholder="タグを入力" style="display: inline;  font-size: 25px; width: 85%;">
                    <input type="button" class="tagaddbtn" value="追加" onclick="addTag()">
                </div>
                <!-- <input type="text" id="tags" name="tags" placeholder="タグを入力">
                <p id="tagPrepare"></p> -->
