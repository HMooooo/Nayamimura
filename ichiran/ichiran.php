...
$records = $db->prepare('SELECT post.id, post.title, post.main, post.time, user.name, user.icon FROM post, user WHERE post.userid=user.id ORDER BY post.time DESC LIMIT ? OFFSET ?');
